...
fun 'Line_Item_PP_,_a_CN_is_deemed_not_to_be_a_CN_.' : Item -> PP -> CN -> CN -> Line ; 
...
fun 'Line_Item_PP_,_where_S_,_S_.' : Item -> PP -> S -> S -> Line ; 
fun 'Line_Item_PP_,_Time_,_S_.' : Item -> PP -> Time -> S -> Line ; 
fun 'Line_Item_where_a_CN_VP_—' : Item -> CN -> VP -> Line ; 
fun 'Line_Item_PP_,_a_CN_is_deemed_to_VP_—' : Item -> PP -> CN -> VP -> Line ; 
fun 'Line_QCN_,_in_relation_to_NP_,_means_—' : QCN -> NP -> Line ; 
fun 'Line_QCN_means_any_CN_;' : QCN -> CN -> Line ; 
fun Line_Ref : Ref -> Line ; 
fun 'Line_Ref_._PP_,_unless_S_—' : Ref -> PP -> S -> Line ; 
...
---- fun Ref_ConjItem : ConjItem -> Ref ;
---- fun Ref_Item : Item -> Ref ;
fun S_NP_VP : NP -> VP -> S ; 
