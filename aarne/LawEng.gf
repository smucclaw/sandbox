...
lin CN_CN_affecting_NP cn np = cn ++ "affecting" ++ np ;
lin CN_CN_mentioned_in_section_Ref cn ref = cn ++ "mentioned" ++ "in" ++ "section" ++ ref ;
...
lin CN_prescribed_personal_data  = "prescribed" ++ "personal" ++ "data" ;
lin CN_prescribed_requirements  = "prescribed" ++ "requirements" ;
...
lin CN_rule_of_law  = "rule" ++ "of" ++ "law" ;
...
lin NP_that_other_CN cn = "that" ++ "other" ++ cn ;
...
lin VP_has_occurred_in_relation_to_NP np = "has" ++ "occurred" ++ "in" ++ "relation" ++ "to" ++ np ;
lin VP_has_reason_to_VP vp = "has" ++ "reason" ++ "to" ++ vp ;
lin VP_has_reason_to_believe_that_S s = "has" ++ "reason" ++ "to" ++ "believe" ++ "that" ++ s ;
