...
The primary legal texts are first converted into ASTs using a GF parser.
...
At the same time, it is intended to be sufficient for this purpose, so that when the grammar is extended (e.g., new law texts), the assembly logic and its back-ends can be kept constant.
