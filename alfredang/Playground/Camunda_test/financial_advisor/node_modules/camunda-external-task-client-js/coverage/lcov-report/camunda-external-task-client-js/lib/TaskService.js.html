...
<html lang="en">
<head>
    <title>Code coverage report for camunda-external-task-client-js/lib/TaskService.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">camunda-external-task-client-js/lib</a> TaskService.js
    </h1>
    <div class='clearfix'>
    </div>
  </div>
...
<span class="cstat-no" title="statement not covered" >      this.error("complete", task, e);</span>
    }
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >      this.error("handleFailure", task, e);</span>
    }
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >      this.error("handleBpmnError", task, e);</span>
    }
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >      this.error("lock", task, e);</span>
    }
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >      this.error("extendLock", task, e);</span>
    }
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >      this.error("unlock", task, e);</span>
    }
  }
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Nov 24 2020 14:58:20 GMT+0100 (Central European Standard Time)
</div>
</div>
