...
'agent'('NonPreAchvI'(_Cont2),'lambda'([_actor3,_evnt3,_initial_evnt_timer2],'&'('>='(_initial_evnt_timer2,'int'(0)),'let'(['agent'('Go3'(_evnt_timer3),'ifte'('=='(_evnt_timer3,'int'(0)),'[]'('prefix'('src_span'(62,11,62,15,1519,4),['out'('true'),'out'(_actor3)],_evnt3,'agent_call'('src_span'(62,30,62,34,1538,4),_Cont2,['true']),'src_span'(62,27,62,29,1534,20)),'prefix'('src_span'(63,14,63,17,1562,3),[],'tic','agent_call'('src_span'(63,21,63,25,1569,4),_Cont2,['false']),'src_span'(63,18,63,20,1565,18)),'src_span_operator'('no_loc_info_available','src_span'(63,11,63,13,1559,2))),'prefix'('src_span'(65,11,65,14,1604,3),[],'tic','agent_call'('src_span'(65,18,65,20,1611,2),'Go3',['-'(_evnt_timer3,'int'(1))]),'src_span'(65,15,65,17,1607,25)),'no_loc_info_available','no_loc_info_available','no_loc_info_available'),'src_span'(61,9,65,36,1485,144))],'agent_call'('src_span'(67,7,67,9,1647,2),'Go3',[_initial_evnt_timer2])))),'src_span'(57,21,67,29,1382,287)).
'agent'('NCPreRule'(_OnDone,_OnTimeout),'let'(['agent'('Cont3'(_is_done),'ifte'(_is_done,_OnDone,_OnTimeout,'src_span'(72,21,72,31,1777,10),'src_span'(72,32,72,36,1787,19),'src_span'(72,44,72,48,1799,21)),'src_span'(72,21,72,58,1777,37))],'agent_call'('src_span'(74,5,74,9,1828,4),'Rule',['agent_call'('src_span'(74,10,74,18,1833,8),'PreAchvI',['Cont3'])])),'src_span'(71,3,74,25,1753,95)).
'bindval'('NCPreOb','agent_call'('src_span'(77,11,77,20,1914,9),'NCPreRule',['val_of'('Tic','src_span'(77,21,77,24,1924,3)),'stop'('src_span'(77,26,77,30,1929,4))]),'src_span'(77,1,77,31,1904,30)).
'bindval'('NCPreProhib','agent_call'('src_span'(80,15,80,24,2005,9),'NCPreRule',['stop'('src_span'(80,25,80,29,2015,4)),'val_of'('Tic','src_span'(80,31,80,34,2021,3))]),'src_span'(80,1,80,35,1991,34)).
'bindval'('CPreRule','agent_call'('src_span'(83,12,83,16,2109,4),'Rule',['agent_call'('src_span'(83,17,83,25,2114,8),'PreAchvI',['lambda'([_],'val_of'('Tic','src_span'(83,32,83,35,2129,3)))])]),'src_span'(83,1,83,37,2098,36)).
'bindval'('MAIN','let'(['bindval'('Procs','setExp'('rangeEnum'(['val_of'('Tic','src_span'(88,7,88,10,2169,3)),'agent_call'('src_span'(89,7,89,14,2180,7),'val_of'('NCPreOb','src_span'(89,7,89,14,2180,7)),['Assessment','assess','int'(30)]),'agent_call'('src_span'(90,7,90,14,2219,7),'val_of'('NCPreOb','src_span'(90,7,90,14,2219,7)),['NotifyPdpc','notify_pdpc','int'(3)]),'agent_call'('src_span'(91,7,91,14,2262,7),'val_of'('NCPreOb','src_span'(91,7,91,14,2262,7)),['NotifyIndiv','notify_indiv','int'(3)]),'agent_call'('src_span'(92,7,92,15,2307,8),'val_of'('CPreRule','src_span'(92,7,92,15,2307,8)),['ProhibitNotifyIndiv','prohibit_notify_indiv','int'(5)])])),'src_span'(87,5,93,6,2153,215))],'procRepSharing'('setExp'('rangeEnum'(['tic'])),['comprehensionGenerator'(_P,'val_of'('Procs','src_span'(95,21,95,26,2398,5)))],_P,'src_span'(95,17,95,28,2394,11))),'src_span'(85,1,95,30,2136,271)).
...
'comment'('lineComment'('-- Template for non-compensable preemptive rule.'),'src_position'(69,1,1671,48)).
'comment'('lineComment'('-- Non-compensable preemptive achievement obligation.'),'src_position'(76,1,1850,53)).
'comment'('lineComment'('-- Non-compensable preemptive achievement prohibition.'),'src_position'(79,1,1936,54)).
'comment'('lineComment'('-- Compensable, pre-emptive obligations, prohibitions and permissions.'),'src_position'(82,1,2027,70)).
...
'symbol'('NCPreRule','NCPreRule','src_span'(70,1,70,10,1720,9),'Funktion or Process').
'symbol'('OnDone','OnDone','src_span'(70,11,70,17,1730,6),'Ident (Prolog Variable)').
'symbol'('OnTimeout','OnTimeout','src_span'(70,19,70,28,1738,9),'Ident (Prolog Variable)').
'symbol'('Cont3','Cont','src_span'(72,5,72,9,1761,4),'Funktion or Process').
'symbol'('is_done','is_done','src_span'(72,10,72,17,1766,7),'Ident (Prolog Variable)').
'symbol'('NCPreOb','NCPreOb','src_span'(77,1,77,8,1904,7),'Ident (Groundrep.)').
'symbol'('NCPreProhib','NCPreProhib','src_span'(80,1,80,12,1991,11),'Ident (Groundrep.)').
'symbol'('CPreRule','CPreRule','src_span'(83,1,83,9,2098,8),'Ident (Groundrep.)').
'symbol'('MAIN','MAIN','src_span'(85,1,85,5,2136,4),'Ident (Groundrep.)').
'symbol'('Procs','Procs','src_span'(87,5,87,10,2153,5),'Ident (Groundrep.)').
'symbol'('P','P','src_span'(95,17,95,18,2394,1),'Ident (Prolog Variable)').