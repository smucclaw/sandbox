...
'comment'('lineComment'('-- NCPreOb(NotifyBorrower, notify_borrower, 3),'),'src_position'(89,7,2392,47)).
...
'symbol'('P','P','src_span'(94,17,94,18,2567,1),'Ident (Prolog Variable)').