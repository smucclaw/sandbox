...
\cite{normative_compliance_guido}.
...
One of the main causes of this is the \textit{concurrent interleaving} of real
world events.
...
\subsection{Formalizing the loan agreement in L4}

\section{Formalizing contracts in B and how it relates to L4}
