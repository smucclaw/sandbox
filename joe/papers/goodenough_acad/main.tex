...
\begin{gather*}
  \begin{prooftree}
    \hypo{\text{if the (actor does action) event is allowed to occur}}
    \infer1{C \longrightarrow \delta_\text{action}(\texttt{actor does action}, \, C)}
  \end{prooftree}
  \\ \\
  \begin{prooftree}
    \infer0{C \longrightarrow \delta_\text{tick}(C)}
  \end{prooftree}
\end{gather*}
