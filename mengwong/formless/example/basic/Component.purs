...
component = H.mkComponent
  ...
  render c =
    UI.section_
      ...
      , HH.p [] [ HH.text $ "parent result message = how do we get output from the component" ]
      ]
    ...
    renderFormless st =
      UI.formContent_
        ...
        , UI.buttonPrimary
            ...
            [ HH.text "Submit" ]
        , HH.p [] [ HH.text $ "result name = " <> show (F.getInput _name st.form) ]
        , HH.p [] [ HH.text $ "result message = " <> show (F.getInput _text st.form) ]
        ]
      where
