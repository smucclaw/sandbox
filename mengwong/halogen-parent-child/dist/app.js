  ...
  var button = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v1) {
              return Click.value;
          }) ])([ Halogen_HTML_Core.text(v.label + (" (" + ((function () {
              if (v.enabled) {
                  return "on";
              };
              return "off";
      ...
      var handleQuery = function (v) {
          ...
          if (v instanceof GetEnabled) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.enabled;
              }))(function (enabled) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value0(enabled)));
              });
          };
          throw new Error("Failed pattern match at Button (line 95, column 17 - line 106, column 34): " + [ v.constructor.name ]);
      };
      var handleAction = function (v) {
          ...
          if (v instanceof Click) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $28.enabled = !state.enabled;
                  return $28;
              }))(function () {
                  return Halogen_Query_HalogenM.raise(Clicked.value);
              });
          };
          throw new Error("Failed pattern match at Button (line 80, column 18 - line 89, column 22): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          ...
          "eval": Halogen_Component.mkEval({
              ...
              receive: function ($31) {
                  return Data_Maybe.Just.create(Receive.create($31));
              },
...
(function($PS) {
  ...
  var HandleButton = (function () {
      ...
      HandleButton.create = function (value0) {
          return new HandleButton(value0);
      };
      return HandleButton;
  })();
  var parent = function (dictMonadEffect) {
      var render = function (v) {
          ...
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "button";
          }))(Data_Ord.ordInt)(Button["_button"])(0)(Button.button)({
              label: clicks + " Enabled"
          })(HandleButton.create), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "button";
          }))(Data_Ord.ordInt)(Button["_button"])(1)(Button.button)({
              label: clicks + " Power"
          })(HandleButton.create), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "button";
