...
(function($PS) {
  ...
  var GetEnabled = (function () {
      function GetEnabled(value0) {
          this.value0 = value0;
      };
      GetEnabled.create = function (value0) {
          return new GetEnabled(value0);
      };
      return GetEnabled;
  })();
  var SetEnabled = (function () {
      function SetEnabled(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetEnabled.create = function (value0) {
          return function (value1) {
              return new SetEnabled(value0, value1);
          };
      };
      return SetEnabled;
  })();
  var _button = Type_Proxy["Proxy"].value;
              ...
              return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(input))(function (v1) {
                  ...
                  var v2 = (function () {
                      if (v1.value0.value instanceof Data_Either.Left && v1.value0.value.value0 instanceof Data_Maybe.Nothing) {
                          return new Data_Tuple.Tuple("None", "You have not made a selection. There is no default.");
                      };
                      if (v1.value0.value instanceof Data_Either.Left && v1.value0.value.value0 instanceof Data_Maybe.Just) {
                          return new Data_Tuple.Tuple(Data_Show.show(dictShow)(v1.value0.value.value0.value0), "You have not made a selection. The default is " + (Data_Show.show(dictShow)(v1.value0.value.value0.value0) + "."));
                      };
                      if (v1.value0.value instanceof Data_Either.Right && v1.value0.value.value0 instanceof Data_Maybe.Nothing) {
                          return new Data_Tuple.Tuple("None", "You have averred that you have no answer.");
                      };
                      if (v1.value0.value instanceof Data_Either.Right && v1.value0.value.value0 instanceof Data_Maybe.Just) {
                          return new Data_Tuple.Tuple(Data_Show.show(dictShow)(v1.value0.value.value0.value0), "You have chosen answer " + (Data_Show.show(dictShow)(v1.value0.value.value0.value0) + "."));
                      };
                      throw new Error("Failed pattern match at Defaultable (line 36, column 29 - line 40, column 81): " + [ v1.value0.value.constructor.name ]);
                  })();
                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text(v1.value0.label + (" = " + v2.value0)) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(pickColor)(input.options))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ dunno_en, reset_en ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.br_, Halogen_HTML_Core.text(v2.value1) ])([ Halogen_HTML_Elements.br_, Halogen_HTML_Core.text(Data_Show.show(Data_Either.showEither(Data_Maybe.showMaybe(dictShow))(Data_Maybe.showMaybe(dictShow)))(v1.value0.value)) ]))))) ]));
              });
          };
      });
  };
...
(function($PS) {
  ...
  var eqRace = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Dwarf && y instanceof Dwarf) {
              return true;
          };
          if (x instanceof Elf && y instanceof Elf) {
              return true;
          };
          return false;
      };
  ...
  var case_1a = {
      age: Data_Either.Left.create(new Data_Maybe.Just(3)),
      height: new Data_Either.Left(Data_Maybe.Nothing.value),
      race: new Data_Either.Left(Data_Maybe.Nothing.value),
      sub_dwarf: new Data_Either.Left(Data_Maybe.Nothing.value),
      sub_elf: new Data_Either.Left(Data_Maybe.Nothing.value)
  };
  var benefit = function (d) {
      return function (f) {
          if (d instanceof Data_Either.Right && d.value0 instanceof Data_Maybe.Just) {
              return f(d.value0.value0);
          };
          if (d instanceof Data_Either.Right && d.value0 instanceof Data_Maybe.Nothing) {
              return true;
          };
          if (d instanceof Data_Either.Left) {
              return true;
          };
          throw new Error("Failed pattern match at Logic (line 19, column 15 - line 22, column 25): " + [ d.constructor.name ]);
      };
  };
  var always = new All([ Data_Function["const"](true) ]);
  var visible_1 = {
      age: always,
      height: new All([ function (v) {
          return benefit(v.age)(function (v1) {
              return v1 > 21;
          });
      } ]),
      race: always,
      sub_dwarf: new All([ function (v) {
          return benefit(v.race)(function (v1) {
              return Data_Eq.eq(eqRace)(v1)(Dwarf.value);
          });
      } ]),
      sub_elf: new All([ function (v) {
          return benefit(v.race)(function (v1) {
              return Data_Eq.eq(eqRace)(v1)(Elf.value);
          });
      } ])
  };
  var aaeval = function (w) {
      return function (v) {
          if (v instanceof Any) {
              return Data_Array.any(function (f) {
                  return f(w);
              })(v.value0);
          };
          if (v instanceof All) {
          ...
          throw new Error("Failed pattern match at Logic (line 24, column 1 - line 24, column 60): " + [ w.constructor.name, v.constructor.name ]);
      };
  };
  var caseEval = function (p) {
      return function (c) {
          return {
              age: aaeval(c)(p.age),
  ...
  exports["caseEval"] = caseEval;
  exports["visible_1"] = visible_1;
  exports["case_1a"] = case_1a;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.3
  "use strict";
  ...
  var parent = function (dictMonadEffect) {
      var render = function (world) {
          var visibility = Logic.caseEval(Logic.visible_1)(world);
          var visibleWorld = Data_Array.catMaybes([ (function () {
              if (visibility.age) {
          ...
          var ziprange = Data_Array.range(1)(Data_Array.length(visibleWorld));
          return Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
                  return "defaultable";
              }))(Data_Ord.ordInt)(_defaultable)(v.value0)(Defaultable.component(Data_Show.showInt))(v.value1);
          })(Data_Array.zip(ziprange)(visibleWorld)));
      };
      var initialState = function (v) {
          return Logic.case_1a;
      };
      var handleAction = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.tell()(new Data_Symbol.IsSymbol(function () {
              return "button";
          }))(Data_Ord.ordInt)(Button["_button"])(0)(Button.SetEnabled.create(true)))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.requestAll()(new Data_Symbol.IsSymbol(function () {
                  return "button";
              }))(Data_Ord.ordInt)(Button["_button"])(Button.GetEnabled.create))(function (on) {
                  return Effect_Class_Console.logShow(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Data_Map_Internal.showMap(Data_Show.showInt)(Data_Show.showBoolean))(on);
              });
          });
      };
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Form.parent(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();